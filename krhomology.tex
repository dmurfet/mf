...
\]
Both $\Xbul, \Xcirc$ are Koszul factorisations associated to certain linear factorisations of $W$. Namely, if we write $t_i = y_i - x_i$ then
...
\begin{align*}
\{ \bs{b}, \bs{a} \}\mdual &\cong \left( \{ b_1, a_1 \} \otimes \ldots \otimes \{ b_n, a_n \} \right)\mdual\\
&\cong \{ b_1, a_1 \}\mdual \otimes \ldots \otimes \{ b_n, a_n \}\mdual\\
&\cong \{ -a_1, b_1 \} \otimes \ldots \otimes \{ -a_n, b_n \} = \{ - \bs{a}, \bs{b} \}.
\end{align*}
\end{proof}
% see ngkos
...
\]
and taking the grading shift by $\{ c - \deg(a) \}$ we have that $\{ a, b \}\langle 1 \rangle\{ c - \deg(a) \}$ is equal to $\{ b, -a \}$. Hence
\begin{align*}
