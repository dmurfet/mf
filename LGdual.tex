...
\]
is defined for homogeneous $\eta \in X$ and $\nu \in X^\dagger$ by
\[
...
\ee
where a $\bullet$ as a superscript indicates post-composition and as a subscript, pre-compostiion. By Proposition \ref{prop:liftingresult} the right hand vertical map is a homotopy equivalence and therefore so is the left hand vertical map. This in particular justifies why in \eqref{eq:defineeval} there is a unique morphism $\widetilde\eval_X$ making the diagram commute.
