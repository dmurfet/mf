...
Throughout this section we write $\Hom(f,g)$ for $\Hom_{\cat{B}(A,B)}(f,f')$.
...
\begin{proposition}\label{prop:uniquext} There is a \emph{unique} way of defining for each $x \in \cat{B}(A,B)$ a pair of $2$-morphisms
\[
