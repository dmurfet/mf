...
We call these \textsl{associative} Atiyah classes to distinguish them from the more standard Atiyah classes defined using commutative differential forms, see \cite{illusie,markarian,buchweitz03,buchweitz08,roberts,huybrechts10}. Since the latter do not appear in this paper except in Section~\ref{section:dualityadjointop}, which is self-contained, we will usually omit the qualifier ``associative''. 
