...
\begin{itemize}
\item can use uniqueness \textsl{up to isomorphism} of adjoints
\item explain eval and coev with wiggly lines
\item define wiggly-line-crosses-solid-line map
\item define 3-valent wiggly vertex
\end{itemize}
...
\begin{lemma}\label{lemma:lameadjoints} Given homogeneous $\psi \in \End(X)$ and $\varphi \in \End(X) \otimes_{R_1} \Bar$ (TODO: $D$ means both $d_X$ and $[d_X,-]$ in this lemma and below)
\begin{align*}
