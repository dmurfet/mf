...
TODO: especially Ragnar Buchweitz, also Ilka Brunner, Daniel Plencner, Ingo Runkel and who else? Peter Petersen.
...
Although $(\Bar, d_{\Bar})$ depends only on the pair $(R,W)$, the matrix factorisation $(\Delta_W, d_{\Delta_W})$ depends in addition on an ordering of the ring variables. The compatibility of $\delta_{+}$ and $\Psi$ in \eqref{eq:deltaplusandpsi} depends on the fact that $\Delta_W$ and $\Psi$ are defined using the \emph{same} ordering.
...
with the $\nZ _2$-grading
\[
\big( X \,\widehat{\otimes}\, \Bar \big)^i = \left( \prod_{m \in \nZ } X^i \otimes \Bar_{2m} \right) \oplus \left( \prod_{m \in \nZ } X^{i+1} \otimes \Bar_{2m+1} \right) . 
\]
...
\draw[very thin, color=blue!85!black, decorate, decoration={snake, amplitude=0.2mm, segment length=1.0mm}] (2.1,0) .. controls +(0.1,0.5) and +(-0.5,-0.45) .. (2.5,0.75); 
\end{tikzpicture}
%%%%%%%%%%%%%%%%%%%%%%
...
\draw[very thin, color=blue!85!black, decorate, decoration={snake, amplitude=0.2mm, segment length=1.0mm}] (1.87,0) .. controls +(0.1,0.5) and +(-0.7,-0.15) .. (2.5,0.75); 
\end{tikzpicture}
%%%%%%%%%%%%%%%%%%%%%%
...
\begin{tikzpicture}[very thick,scale=1.0,color=blue!50!black, baseline=.3cm]
\draw[redirected] (3,0) .. controls +(0,1) and +(0,1) .. (2,0);
\draw[very thin, color=blue!85!black, decorate, decoration={snake, amplitude=0.2mm, segment length=1.0mm}] (2.9,0) .. controls +(-0.1,0.5) and +(0.5,-0.45) .. (2.5,0.75); 
\end{tikzpicture}
%%%%%%%%%%%%%%%%%%%%%%
...
\begin{tikzpicture}[very thick,scale=1.0,color=blue!50!black, baseline=-.4cm,rotate=180]
\draw[directed] (3,0) .. controls +(0,1) and +(0,1) .. (2,0);
\draw[very thin, color=blue!85!black, decorate, decoration={snake, amplitude=0.2mm, segment length=1.0mm}] (3.13,0) .. controls +(-0.1,0.5) and +(0.7,-0.15) .. (2.5,0.75); 
\end{tikzpicture}
%%%%%%%%%%%%%%%%%%%%%%
...
\draw (-1,0) -- (-1,1.25); 
\draw (1,0) -- (1,-1.25); 
\draw[very thin, color=blue!85!black, decorate, decoration={snake, amplitude=0.2mm, segment length=1.0mm}] (-0.5,-0.75) .. controls +(0.75,0) and +(-0.5,-0.35) .. (0.5,0.75); 
\end{tikzpicture}
%%%%%%%%%%%%%%%%%%%%%%
\;=\;
%%%%%%%%%%%%%%%%%%%%%%
...
\draw (-1,0) -- (-1,-1.25); 
\draw (1,0) -- (1,1.25); 
\draw[very thin, color=blue!85!black, decorate, decoration={snake, amplitude=0.2mm, segment length=1.0mm}] (-0.9,-1.25) .. controls +(0,0.5) and +(-0.5,-0.35) .. (-0.5,0.75); 
\draw[very thin, color=blue!85!black, decorate, decoration={snake, amplitude=0.2mm, segment length=1.0mm}] (0.5,-0.75) .. controls +(0.8,0.05) and +(0,-1) .. (1.1,1.25); 
\end{tikzpicture}
%%%%%%%%%%%%%%%%%%%%%%
\;=\;
%%%%%%%%%%%%%%%%%%%%%%
\begin{tikzpicture}[very thick,scale=1.0,color=blue!50!black, baseline=0cm]
\draw (0,-1.25) -- (0,1.25); 
\draw[very thin, color=blue!85!black, decorate, decoration={snake, amplitude=0.2mm, segment length=1.0mm}] (0.15,-1.25) -- (0.15,1.25); 
\end{tikzpicture} \, .
%%%%%%%%%%%%%%%%%%%%%%
$$
...
\draw[very thin, color=blue!85!black, decorate, decoration={snake, amplitude=0.2mm, segment length=1.0mm}] (0,0) -- (0.5,0.75);
\draw[very thin, color=blue!85!black, decorate, decoration={snake, amplitude=0.2mm, segment length=1.0mm}] (1,0) -- (0.5,0.75);
\end{tikzpicture}
%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%
\begin{tikzpicture}[very thick,scale=1.0,color=blue!50!black, baseline=0cm]
\draw[very thin, color=blue!85!black, decorate, decoration={snake, amplitude=0.2mm, segment length=1.0mm}] (-0.3,-0.75) .. controls +(0,0.5) and +(0,-0.5) ..  (0.3,0.75);
\draw (0,-0.75) -- (0,0.75); 
\end{tikzpicture}
%%%%%%%%%%%%%%%%%%%%%%
...
\section{How I Learned To Stop Worrying and Love Signs}

Objects of the bicategory $\LG$ are pairs consisting of a polynomial ring $R$ and potential $W$, together with a chosen ordering of the ring variables. Thus the value of a diagram in $\LG$ depends \emph{a priori} on the ordering of the ring variables in each of its $2$-dimensional regions. In this section we show that the value is actually independent of these orderings, up to the natural signs.
...
\shadedraw[top color=white, bottom color=white, draw=white] (0,0) circle (2);
%
\draw[very thin, color=blue!85!black, decorate, decoration={snake, amplitude=0.2mm, segment length=1.0mm}] (270:2) .. controls +(3,0) and +(3,-1) .. (90:2); 
\fill (180:1.8) circle (0pt) node[left] {{\small$X$}};
\draw (0,0) circle (2);
\draw[<-, very thick] (0.100,2) -- (-0.101,2) node[above] {}; 
\draw[<-, very thick] (-0.100,-2) -- (0.101,-2) node[below] {}; 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\ee
We show in Section \ref{sec:defectaction} that the value of this diagram is the endomorphism of $\Delta_V$ given by multiplication with the polynomial $(-1)^{{m+1\choose 2}} \str( \partial_{z_1} d_X \ldots \partial_{z_m} d_X )$. While there is an obvious dependence on the variable ordering, we prove that the homotopy equivalence class of this endomorphism changes only by a sign (the sign of the permutation) if we permute the ordering of the variables $z_i$ in the outer region of the diagram.
...
\ee
Together with the morphisms $\rho, \lambda$ of \eqref{lambdarho} this matrix factorisation serves as an alternative unit $1$-endomorphism of $(R,W)$. That is, $\rho$ and $\lambda$ are both isomorphisms and the coherence axiom for the unit in a bicategory holds for $\Delta^\sigma_W$. 
...
\[
\xymatrix@C+1pc{
\Delta_W \ar[r]^-{\lambda_{\Delta_W}^{-1}} & \Delta^\sigma_W \otimes_R \Delta_W \ar[r]^-{\rho_{\Delta^\sigma_W}} & \Delta^\sigma_W
}\,,
\]
...
To understand how permuting variables affects the values of diagrams like \eqref{eq:signdependencepermdia}, we need to understand the effect on the evaluation and coevaluation maps of Section \ref{sec:derivcoeval}. For the remainder of the section we fix potentials $W \in R = k[x_1,\ldots,x_n], V \in S = k[z_1,\ldots,z_m]$ and $X \in \hmf(k[x,z], V - W)$.
...
\[
\Res_{k[x]/k} \!\!\left[ \frac{ \str( \lambda_1 \ldots \lambda_n \circ (-) ) \underline{\ud x}}{\partial_{x_1} W \ldots \partial_{x_n} W} \right] \quad
...
Returning to the example \eqref{eq:signdependencepermdia} we have a diagram, in which the top row computes the value of the diagram with outer region given the usual variable ordering, and the bottom row computes the value given the ordering $z_{\tau(1)}, \ldots, z_{\tau(m)}$
\[
\xymatrix@C+2pc{
\Delta_V \ar[d] \ar[r] & X \otimes_R X^{\vee} \otimes_S S[m] \ar[r] & X \otimes_R R[m] \otimes_R X^{\vee} \ar[r] & \Delta_V \ar[d]\\
\Delta^\tau_V \ar[r] & X \otimes_R X^{\vee} \otimes_S S[m] \ar[r] & X \otimes_R R[m] \otimes_R X^{\vee} \ar[r] & \Delta^\tau_V
}
\]
We have shown that this diagram commutes in $\HMF(\Se, \widetilde V)$ up to a sign $(-1)^{|\tau|}$.
...
\draw (-1,0) -- (XY);
%
\draw[very thin, color=blue!85!black, decorate, decoration={snake, amplitude=0.2mm, segment length=1.0mm}] (-0.35,-0.76) .. controls +(-0.7,0.5) and +(0.1,-1) .. (-0.85,1.6); 
%
\draw[very thin, color=blue!85!black, decorate, decoration={snake, amplitude=0.2mm, segment length=1.0mm}] (2.15,-0.65) .. controls +(0,1) and +(0.7,-0.15) .. (1.5,0.75); 
%
\draw[very thin, color=blue!85!black, decorate, decoration={snake, amplitude=0.2mm, segment length=1.0mm}] (3.15,-0.65) .. controls +(0,1.1) and +(1.8,0) .. (1.5,1.5); 
\end{tikzpicture}
%%%%%%%%%%%%%%%%%%%%%%
=
%%%%%%%%%%%%%%%%%%%%%%%
...
%\draw (2,0) -- (XY);
%%
%\draw[very thin, color=blue!85!black, decorate, decoration={snake, amplitude=0.2mm, segment length=1.0mm}] (1.85,1.59) .. controls +(-0.01,-1.6) and +(0.7,0.1) .. (1.25,-0.7); 
%%
%\draw[very thin, color=blue!85!black, decorate, decoration={snake, amplitude=0.2mm, segment length=1.0mm}] (-1.15,-0.65) .. controls +(0,1) and +(-0.7,0) .. (-0.4,0.77); 
%%
%\draw[very thin, color=blue!85!black, decorate, decoration={snake, amplitude=0.2mm, segment length=1.0mm}] (-2.15,-0.65) .. controls +(0,1.1) and +(-1.8,0) .. (-0.4,1.5); 
%\end{tikzpicture}
%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%
\begin{tikzpicture}[very thick,scale=0.8,color=blue!50!black, baseline, rotate=180]
...
\draw (2,0) -- (XY);
%
\draw[very thin, color=blue!85!black, decorate, decoration={snake, amplitude=0.2mm, segment length=1.0mm}] (2.15,1.59) .. controls +(-0.01,-1.0) and +(0.7,0.1) .. (1.25,-0.7); 
%
\draw[very thin, color=blue!85!black, decorate, decoration={snake, amplitude=0.2mm, segment length=1.0mm}] (-0.85,-0.65) .. controls +(-0.3,0.9) and +(-0.7,0) .. (-0.4,0.77); 
%
\draw[very thin, color=blue!85!black, decorate, decoration={snake, amplitude=0.2mm, segment length=1.0mm}] (-1.85,-0.65) .. controls +(-0.3,1.0) and +(-1.8,0) .. (-0.4,1.5); 
\end{tikzpicture}
%%%%%%%%%%%%%%%%%%%%%%
\ee
\end{enumerate}
...
\draw (-1,0) -- (XY);
%
\draw[very thin, color=blue!85!black, decorate, decoration={snake, amplitude=0.2mm, segment length=1.0mm}] (-0.35,-0.76) .. controls +(-0.7,0.5) and +(0.1,-1) .. (-0.85,2.67); 
%
\draw[very thin, color=blue!85!black, decorate, decoration={snake, amplitude=0.2mm, segment length=1.0mm}] (2.15,-1.735) .. controls +(0,2) and +(0.7,-0.15) .. (1.5,0.75); 
%
\draw[very thin, color=blue!85!black, decorate, decoration={snake, amplitude=0.2mm, segment length=1.0mm}] (3.15,-1.735) .. controls +(0,2) and +(1.8,0) .. (1.5,1.5); 
%
%
...
\fill (-1.1,-1.1) circle (0pt) node[white] {{\small$V$}};
%
\draw[very thin, color=blue!85!black, color=blue!85!black, decorate, decoration={snake, amplitude=0.2mm, segment length=1.0mm}] (270:2) .. controls +(-3,0) and +(-3,-1) .. (90:2); 
\draw (0,0) circle (2);
\draw[<-, very thick] (0.100,-2) -- (-0.101,-2) node[above] {}; 
\draw[<-, very thick] (-0.100,2) -- (0.101,2) node[below] {}; 
\fill (135:0) circle (3.3pt) node[left] {{\small$\phi$}};
...
%	
% wiggly lines: 
\draw[very thin, color=blue!85!black, decorate, decoration={snake, amplitude=0.2mm, segment length=1.0mm}] 
...
%
% wiggly lines:
\draw[very thin, color=blue!85!black, decorate, decoration={snake, amplitude=0.2mm, segment length=1.0mm}] (-2,0.5) .. controls +(-3.5,0) and +(-4,-0.5) .. (0,5.2); 
\draw[very thin, color=blue!85!black, decorate, decoration={snake, amplitude=0.2mm, segment length=1.0mm}] (-2,-3.5) .. controls +(-2.5,0) and +(-2,-1) .. (-2,-0.5); 
\draw[very thin, color=blue!85!black, decorate, decoration={snake, amplitude=0.2mm, segment length=1.0mm}] (2,-3.5) .. controls +(-3,0) and +(0,-1) .. (0,3); 
\draw[very thin, color=blue!85!black, decorate, decoration={snake, amplitude=0.2mm, segment length=1.0mm}] (2,0.5) .. controls +(-1.7,0) and +(0,-1) .. (0,3); 
%
% label arrowheads: 
...
\fill (135:1) circle (2.5pt) node[left] {{\small$\varphi$}};
%
\draw[very thin, color=blue!85!black, decorate, decoration={snake, amplitude=0.2mm, segment length=1.0mm}] (270:1) .. controls +(-2,0) and +(-2,-0.2) .. (90:2); %decorate, decoration={zigzag}
\end{tikzpicture} 
%%%%%%%%%%%%%%%%%%%%%%%%%% 
\ee
