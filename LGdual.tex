...
\begin{theorem}
The bicategory $\LG$ has adjoints. Explicit expressions for the evaluation and coevaluation maps are given by~\eqref{TODO}. 
\end{theorem}
...
TODO: definition of pivotal in bicategory with right adjoints: monoidal natural 2-isomorphism, or equivalently: two diagram identities

TODO: Lemma: pivotal equivalent to having (co)ev and (co)ev-tilde. 

TODO: Proposition: $\LG$ is pivotal (this will incorportate what is now Proposition~\ref{prop:monoidalproperty})
