...
\fill (-1.1,-1.1) circle (0pt) node[white] {{\small$V$}};
%
\draw[very thin, decorate, decoration={snake, amplitude=0.3mm, segment length=1.2mm}] (270:2) .. controls +(-3,0) and +(-3,-1) .. (90:2); 
\draw (0,0) circle (2);
\draw[<-, very thick] (0.100,-2) -- (-0.101,-2) node[above] {}; 
\draw[<-, very thick] (-0.100,2) -- (0.101,2) node[below] {}; 
\fill (135:0) circle (3.3pt) node[left] {{\small$\phi$}};
...
\begin{align*}
\mathcal D_l^\Phi(X)(\phi) & 
= (-1)^{{m\choose 2} +}\Res_{k[x,z]/k[x]} \left[ \frac{\phi(z) \str\big( \partial_{x_n} d_{X}\ldots \partial_{x_1} d_{X} \partial_{z_1} d_{X}\ldots \partial_{z_m} d_{X} \big) \underline{\operatorname{d}\! z}}{\partial_{z_1} V \ldots \partial_{z_m} V} \right] \, , \\
\mathcal D_r^\Phi(X)(\psi) & = (-1)^{{m\choose 2} + {n\choose 2}}  \Res_{k[x,z]/k[z]} \left[ \frac{\psi(x) \str\big( \partial_{x_1} d_{X}\ldots \partial_{x_n} d_{X} \partial_{z_1} d_{X}\ldots \partial_{z_m} d_{X} \big) \underline{\operatorname{d}\! x}}{\partial_{x_1} W \ldots \partial_{x_n} W} \right] \, . 
\end{align*}
\end{proposition}
...
\fill (135:1) circle (2.5pt) node[left] {{\small$\varphi$}};
%
\draw[very thin, decorate, decoration={snake, amplitude=0.3mm, segment length=1.2mm}] (270:1) .. controls +(-2,0) and +(-2,-0.2) .. (90:2); %decorate, decoration={zigzag}
\end{tikzpicture} 
%%%%%%%%%%%%%%%%%%%%%%%%%%
TODO 
\ee
