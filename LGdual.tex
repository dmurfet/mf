...
\draw[very thin, decorate, decoration={snake, amplitude=0.2mm, segment length=1.0mm}] (0.5,-0.75) .. controls +(0.5,0.35) and +(0,-0.5) .. (0.9,1.25); 
\end{tikzpicture}
%%%%%%%%%%%%%%%%%%%%%%
\;=\;
%%%%%%%%%%%%%%%%%%%%%%
\begin{tikzpicture}[very thick,scale=1.0,color=blue!50!black, baseline=0cm]
\draw (0,-1.25) -- (0,1.25); 
\draw[very thin, decorate, decoration={snake, amplitude=0.2mm, segment length=1.0mm}] (0.1,-1.25) -- (0.1,1.25); 
\end{tikzpicture} \, .
%%%%%%%%%%%%%%%%%%%%%%
$$
...
\end{tikzpicture}
%%%%%%%%%%%%%%%%%%%%%%
: R[n] \otimes_R R[n] \lra R \, , \qquad r_1\otimes r_2 \lmt (-1)^{n |r_1|} r_1 r_2 \, . 
$$
