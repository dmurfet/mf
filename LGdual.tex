...
\end{align*}
In this notation the Zorro moves e.\,g.~for the left adjoints read (TODO: other Zorros as well, with arrows)
$$
%%%%%%%%%%%%%%%%%%%%%%
\begin{tikzpicture}[very thick,scale=1.0,color=blue!50!black, baseline=0cm]
\draw[directed] (0,0) .. controls +(0,-1) and +(0,-1) .. (-1,0);
...
(TODO: get rid of Definition of pivotal, just discuss it a little bit...)
...
Diagrammatically these definitions read (TODO: no subscripts for lambda, but label with $X$)
\begin{align}
