...
\psi & \lmt (-1)^{{m\choose 2} + {n\choose 2}} \Res_{k[x,z]/k[x]} \left[ \frac{\str\left( \psi\,  \partial_{x_1} d_X \ldots \partial_{x_n} d_X \partial_{z_1} d_X \ldots \partial_{z_m} d_X \right) \underline{\operatorname{d}\!x}}{\partial_{x_1}  \ldots \partial_{x_n} W} \right] \, . 
\end{align*}
