...
Z = \sum_j (-1)^{|e_j| + n + {n+1\choose 2}} \Res_{k[x']} \left[ \frac{\str (\underline\lambda' (\varepsilon\circ\Psi) \At(d_{X\otimes X^\vee})^n (-\otimes e_j^* \otimes e_j) ) \underline{dx'}}{\partial_{x'_1}W \ldots \partial_{x'_n} W} \right]
\ee
